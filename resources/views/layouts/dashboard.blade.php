...
<head>
    ...
    <title>Dot Optimize - Find Your Desired IT Solution</title>
    <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('home')}}" class="brand-logo">
                ...
                <img class="logo-abbr" src="{{asset('frontend/images/favicon.png')}}" alt="">
                <img class="logo-compact" src="{{asset('frontend/images/logos.png')}}" alt="">
                <img class="brand-title" src="{{asset('frontend/images/logos.png')}}" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css text-center " style="font-size: 14px;">{{App\Models\Quote::where('status', 0)->count()}}</div>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
										@forelse (App\Models\Quote::where('status', 0)->get() as $quote)
											<li>
												<a href="{{route('Quote.view', $quote->id)}}">
													<div class="timeline-panel">
														<div class="media-body">
															<h6 class="mb-1">{{$quote->name}} Send you Quote</h6>
															<small class="d-block">{{$quote->created_at->diffForHumans()}}</small>
														</div>
													</div>
												</a>
											</li>
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css text-center " style="font-size: 14px;">{{App\Models\UserMessage::where('status', 0)->count()}}</div>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											@forelse (App\Models\UserMessage::where('status', 0)->get() as $message)
											<li>
												<a href="{{route('message.view', $message->id)}}">
													<div class="timeline-panel">
														<div class="media-body">
															<h6 class="mb-1">{{$message->user_name}} Send you Message</h6>
											...
											@empty
											<strong class="text-danger text-center">You have No Message Here!</strong>
											@endforelse
										</ul>
									</div>
                                    <a class="all-notification" href="{{route('message.list')}}">See all notifications <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css text-center " style="font-size: 14px;">{{App\Models\Contact::where('status', 0)->count()}}</div>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											@forelse (App\Models\Contact::where('status', 0)->get() as $contact)
											<li>
												<a href="{{route('contact.view', $contact->id)}}">
													<div class="timeline-panel">
														<div class="media-body">
															<h6 class="mb-1">{{$contact->name}} Send you Message</h6>
															<small class="d-block">{{$contact->created_at->diffForHumans()}}</small>
														</div>
													</div>
												</a>
											</li>
                                    ...
                                    <a class="all-notification" href="{{route('contact.list')}}">See all notifications <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="{{route('home.seo')}}">Home SEO</a></li>
							<li><a href="{{route('about.seo')}}">About SEO</a></li>
							<li><a href="{{route('service.seo')}}">Service SEO</a></li>
							<li><a href="{{route('project.seo')}}">Project SEO</a></li>
							<li><a href="{{route('product.seo')}}">Product SEO</a></li>
							<li><a href="{{route('blog.seo')}}">Blog SEO</a></li>
							<li><a href="{{route('career.seo')}}">Careers SEO</a></li>
							<li><a href="{{route('career.job.sub')}}">Careers Subject Seo</a></li>
							<li><a href="{{route('press.media.seo')}}">Press Media Seo</a></li>
							<li><a href="{{route('company.seo')}}">Company Seo</a></li>
							<li><a href="{{route('privacy.policy.seo')}}">Privacy Policy Seo</a></li>
							<li><a href="{{route('case.studies.seo')}}">Case Studies Seo</a></li>
							<li><a href="{{route('how.it.work.seo')}}">How It Work</a></li>
						</ul>
					</li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-networking"></i>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('customer')}}">Customer List</a></li>
                            <li><a href="{{route('customer.support')}}">Customer Support</a></li>
                            <li><a href="{{route('applicant')}}">Applicant List</a></li>
                            <li><a href="{{route('customer.provide.info')}}">Customer Provide info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-controls-3"></i>
							<span class="nav-text">Nav & Banner</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('nav.logo')}}">Add Logo</a></li>
                            <li><a href="{{route('nav.menu')}}">Menu List</a></li>
                            <li><a href="{{route('banner')}}">Edit Banner Info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('about.info')}}">Edit About Info</a></li>
                            <li><a href="{{route('client')}}">Our Clint</a></li>
                            <li><a href="{{route('skill')}}">Skill List</a></li> 
                            <li><a href="{{route('work')}}">Edit Work Info</a></li> 
                            <li><a href="{{route('overview')}}">Edit Company Overview</a></li> 
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-layer-1"></i>
						...
						<ul aria-expanded="false">
							<li><a href="{{route('project.section.title')}}">Add Section Title</a></li>
					...
					<ul aria-expanded="false">
						...
						<li><a href="{{route('product.section.title')}}">Product Section Title</a></li>
					</ul>
				</li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('member.section.title')}}">Add Section Title</a></li>
                            <li><a href="{{route('member')}}">Add Member</a></li>
                            <li><a href="{{route('member.list')}}">Member List</a></li>
                            <li><a href="{{route('member.skill')}}">Member Skills</a></li>
                            <li><a href="{{route('member.icon')}}">Social Icon</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('testimonial.content')}}">Update Content</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('blog.list')}}">All Blog List</a></li>
                            <li><a href="{{route('add.category')}}">Add Category</a></li>
                            <li><a href="{{route('add.tag')}}">Add Tags</a></li>
                            <li><a href="{{route('comment')}}">Comment View</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					...
					<ul aria-expanded="false">
						<li><a href="{{route('contact.content')}}">Contact content</a></li>
					</ul>
					</li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-layer-1"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('add.plan')}}">Pricing Plan</a></li>
                        </ul>
                    </li>
					<li>
						...
						<ul aria-expanded="false">
							<li><a href="{{route('order')}}">Order Information</a></li>
						</ul>
					</li>
					{{-- <li><a class="has-arrow ai-icon" href="{{route('work.way')}}" aria-expanded="false">
						<i class="flaticon-381-layer-1"></i>
						<span class="nav-text">Work Way</span>
						</a>
					</li> --}}
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-layer-1"></i>
						...
						<ul aria-expanded="false">
							<li><a href="{{route('add.title')}}">Request_Form</a></li>
							<li><a href="{{route('footer.info')}}">Company Info</a></li>
							<li><a href="{{route('work.way')}}">Add work way</a></li>
							<li><a href="{{route('edit.policy')}}">Edit Privacy Policy</a></li>
							<li><a href="{{route('copyright')}}">Update Copyright Content</a></li>
							<li><a href="{{route('call.information')}}">Call For More Information
							</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('subscribe.list')}}">Subcription</a></li>
                            <li><a href="{{route('quote.list')}}">Quotation</a></li>
                            <li><a href="{{route('message.list')}}">Request Message</a></li>
                            <li><a href="{{route('contact.list')}}">Contact Message</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-networking"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('api')}}">Api Configuration</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="{{route('role')}}" aria-expanded="false">
						<i class="flaticon-381-networking"></i>
							<span class="nav-text">Rol Management</span>
						</a>
                    </li>
                </ul>
			</div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://www.dotoptimize.com/" target="_blank">Dot Optimize</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
