        ...
        <div class="col-lg-10 m-auto">
            <div class="card">
                <div class="card-header">
                 <h3>Update Blog Page SEO</h3>
                </div>
                <div class="card-body">
                    <form action="{{route('how.it.work.seo.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label>Title</label>
                        ...
                        <div class="mb-3">
                            <img src="{{asset('upload/howI_it_work_seo')}}/{{$seos->image}}" id="blah" alt="your image" width="100" height="100" />
                        </div>
                        <div class="mb-3">
