    ...
    <div class="row mt-5">
        <div class="col-lg-10 m-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('blog.seo.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label>Title</label>
                        ...
                        <div class="mb-3">
                            <img src="{{asset('upload/blog_seo_img')}}/{{$seos->image}}" id="blah" alt="your image" width="100" height="100" />
                        </div>
                        <div class="mb-3">
